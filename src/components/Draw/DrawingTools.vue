<template>
  <ul class="tw-list-none tw-flex tw-flex-wrap" style="padding: 0;">
    ...
    <li class="tw-p-1"><a class="tw-flex tw-items-center tw-rounded-lg tw-p-2 tw-border hover:tw-border-tertiary tw-w-12 tw-h-12" href="javascript:void(0)"><img class="tw-mx-auto" src="@/assets/img/draw_curve.svg" /></a></li>
  </ul>
</template>
